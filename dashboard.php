...
<body>
    <div class="container">
        <div class="sidebar">
            ...
            <div class="nav-links">
                <a href="dashboard.php" class="active">Dashboard</a><br>
                <a href="add_income.php">Add Income</a><br>
                <a href="add_expense.php">Add Expense</a><br>
                <a href="export_transactions.php">Export Transactions</a><br>
